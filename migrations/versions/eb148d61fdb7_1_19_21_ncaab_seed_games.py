"""1 19-21 ncaab seed games

Revision ID: eb148d61fdb7
Revises: e0f304a7d75c
Create Date: 2025-11-06 20:57:50.773717
...
revision: str = 'eb148d61fdb7'
down_revision: Union[str, None] = 'e0f304a7d75c'
...
def upgrade() -> None:
    ...
    def get_historical_games(retries=4, delay=1):
        ...
        sdql_query = fields + f"@site='home' and date>=20150101 and date<20160101"
