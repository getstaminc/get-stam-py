"""1 seed mlb neutral games

Revision ID: 9545f26a9a4f
Revises: 9a3ae0a8320a
Create Date: 2025-08-30 21:29:24.829976
...
revision: str = '9545f26a9a4f'
down_revision: Union[str, None] = '9a3ae0a8320a'
...
def get_historical_games(team, retries=3, delay=1):
    ...
    sdql_query = f"date,site,team,o:team,runs,o:runs,total,margin,line,o:line,playoffs,start time,_t,starter,o:starter,line F5,o:line F5,total F5,total over F5 odds,inning runs,o:inning runs@team='{team}' and site='neutral' and date>20150101"
...
def upgrade():
    ...
    # Key: (date, team1, team2, start_time) where team1 < team2 alphabetically
    processed_games = set()
    ...
    for team in teams_dict.keys():
        ...
        for game in games:
            ...
            # Create deduplication key: (date, team1, team2, start_time) where team1 < team2 alphabetically
            team1, team2 = sorted([mapped_home_team, mapped_away_team])
            dedup_key = (game['date'], team1, team2, game['start time'])
            
            if dedup_key in processed_games:
                print(f"Skipping duplicate game: {game['date']} {mapped_home_team} vs {mapped_away_team} at {game['start time']}")
                continue
