"""4 seed ncaaf with total

Revision ID: cf829e881f81
Revises: 446e0a9521b0
Create Date: 2025-08-16 21:43:43.328490
...
revision: str = 'cf829e881f81'
down_revision: Union[str, None] = '446e0a9521b0'
...
def get_historical_games(team, retries=3, delay=1):
    ...
    sdql_query = f"date,site,team,o:team,points,o:points,total,margin,line,o:line,quarter scores,o:quarter scores,playoffs,money line,o:money line,start time,_t@team='{team}' and site='home'and date>20090101 and date<20250201"
...
def upgrade():
    ...
    for i, team in enumerate(teams):
        ...
        # Add a small delay between teams to avoid overwhelming the API
        if i > 0:
            time.sleep(2)
        ...
        # Add progress logging every 10 teams
        if (i + 1) % 10 == 0:
            print(f"Completed processing {i+1} teams...")
