"""epl game 2025 as of sept 3

Revision ID: fe2af5265008
Revises: 9545f26a9a4f
Create Date: 2025-09-03 20:40:09.653297
...
revision: str = 'fe2af5265008'
down_revision: Union[str, None] = '9545f26a9a4f'
...
def upgrade():
    # Path to your CSV file (relative to this migration file)
    csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl25.26 8.31.25.csv")
