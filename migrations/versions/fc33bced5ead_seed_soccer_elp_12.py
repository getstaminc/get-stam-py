...
Revision ID: fc33bced5ead
Revises: 3b6fd068ec7d
Create Date: 2025-07-08 20:37:27.799024
...
revision: str = 'fc33bced5ead'
down_revision: Union[str, None] = '3b6fd068ec7d'
...
def upgrade():
    ...
    csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl11_12.csv")
