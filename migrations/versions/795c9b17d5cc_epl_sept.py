...
Revision ID: 795c9b17d5cc
Revises: fe2af5265008
Create Date: 2025-09-15 21:27:53.238001
...
revision: str = '795c9b17d5cc'
down_revision: Union[str, None] = 'fe2af5265008'
...
def upgrade():
    ...
    csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl.25.09.csv")
