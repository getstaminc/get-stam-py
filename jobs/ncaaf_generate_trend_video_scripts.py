...
# invocation) — set MAX_VIDEO_GAMES_PER_DAY_NCAAF to change. The daily
...
def run(date_str=None, max_games=None, lookahead=False, time_pref=None):
    """Generate NCAAF trend video scripts for date_str.

    max_games: cap on how many games get a video (defaults to
        MAX_VIDEO_GAMES_PER_DAY_NCAAF for manual/standalone runs — the daily
