"""6 seed nfl games table

Revision ID: 8ee3520167f2
Revises: 19e30086f5bd
Create Date: 2025-06-01 21:58:05.355860
...
revision: str = '8ee3520167f2'
down_revision: Union[str, None] = '19e30086f5bd'
...
def convert_start_time_to_time(start_time: str) -> datetime.time:
    ...
    """
    try:
        # Handle specific invalid case: 2435 -> 1230
        if start_time == "2435":
