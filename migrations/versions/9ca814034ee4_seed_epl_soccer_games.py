"""seed epl soccer games

Revision ID: 9ca814034ee4
Revises: df4edbec7ed1
Create Date: 2025-07-06 20:39:52.667947
...
revision: str = '9ca814034ee4'
down_revision: Union[str, None] = 'df4edbec7ed1'
...
def upgrade():
    ...
    csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl10_11.csv")
