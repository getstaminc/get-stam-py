"""seed soccer elp 14-15-16

Revision ID: cdd0384a07c3
Revises: db145775dbe7
Create Date: 2025-07-08 21:03:38.106346
...
revision: str = 'cdd0384a07c3'
down_revision: Union[str, None] = 'db145775dbe7'
...
def upgrade():
    ...
    csv_files = [
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl14_15.csv"),
    ]
