"""1 seed mlb games table (2015-2020)

Revision ID: e1ee33772ca0
Revises: 9c03298fda01
Create Date: 2025-08-27 10:44:41.392445
...
revision: str = 'e1ee33772ca0'
down_revision: Union[str, None] = '9c03298fda01'    
...
def get_historical_games(team, retries=3, delay=1):
    ...
    sdql_query = f"date,site,team,o:team,runs,o:runs,total,margin,line,o:line,playoffs,start time,_t,starter,o:starter,line F5,o:line F5,total F5,total over F5 odds,inning runs,o:inning runs@team='{team}' and site='home' and date>20210101 and date<2025001"
