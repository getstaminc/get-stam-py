...
Revision ID: c674b45b084a
Revises: f714747c56e3
Create Date: 2025-07-08 21:56:01.450323
...
revision: str = 'c674b45b084a'
down_revision: Union[str, None] = 'f714747c56e3'
...
def upgrade():
    ...
    csv_files = [
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl21_22.csv"),
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl22_23.csv"),
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl23_24.csv"),
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - 24_25 c.csv"),
    ]
