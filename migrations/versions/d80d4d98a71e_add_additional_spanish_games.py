"""add additional spanish games

Revision ID: d80d4d98a71e
Revises: 6f434a584626
Create Date: 2025-11-06 20:21:35.353736
...
revision: str = 'd80d4d98a71e'
down_revision: Union[str, None] = '6f434a584626'
...
def upgrade() -> None:
    ...
    # Only import this single CSV file (do not scan the whole directory)
    target_filename = "League_ Spain - Sheet19.csv"
    target_path = os.path.join(base_dir, target_filename)
    if os.path.isfile(target_path):
        csv_files = [target_path]
    else:
        print(f"[alembic] target CSV not found: {target_filename}; skipping.")
        csv_files = []
