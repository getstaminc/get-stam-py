  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        <Typography variant="h5" component="h3" gutterBottom sx={{ mt: 3, color: '#333' }}>
          Interpretation
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Box component="ul" sx={{ pl: 3, mb: 3 }}>
          ...
          <Box component="li" sx={{ mb: 1 }}>
            <Typography variant="body1">
              <strong>Website</strong> refers to getstam.com, accessible from https://www.getstam.com/
            </Typography>
          </Box>
          <Box component="li" sx={{ mb: 1 }}>
            <Typography variant="body1">
        ...
        <Typography variant="h6" component="h4" gutterBottom sx={{ mt: 2, color: '#555' }}>
          Personal Data
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Box sx={{ pl: 2, mb: 3 }}>
          <Typography variant="h6" component="h5" gutterBottom sx={{ color: '#555' }}>
