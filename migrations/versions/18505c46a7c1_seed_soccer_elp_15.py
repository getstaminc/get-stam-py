...
Revision ID: 18505c46a7c1
Revises: cdd0384a07c3
Create Date: 2025-07-08 21:20:52.356776
...
revision: str = '18505c46a7c1'
down_revision: Union[str, None] = 'cdd0384a07c3'
...
def upgrade():
    ...
    csv_files = [
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl15_16.csv"),
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl16_17.csv"),
