...
Revision ID: f714747c56e3
Revises: 18505c46a7c1
Create Date: 2025-07-08 21:43:45.332415
...
revision: str = 'f714747c56e3'
down_revision: Union[str, None] = '18505c46a7c1'
...
def parse_game_date(date_str):
    """
    Parse a date string that may be in DD/MM/YY or DD/MM/YYYY format.
...
def upgrade():
    ...
    csv_files = [
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl17_18.csv"),
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl18_19.csv"),
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl19_20.csv"),
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl20_21.csv"),
    ...
    for csv_path in csv_files:
        with open(csv_path, newline='', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                ...
                # Parse date (supports both DD/MM/YY and DD/MM/YYYY)
