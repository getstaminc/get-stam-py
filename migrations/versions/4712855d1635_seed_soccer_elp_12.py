...
Revision ID: 4712855d1635
Revises: 4baa8f03b8ec
Create Date: 2025-07-08 20:55:59.871611
...
revision: str = '4712855d1635'
down_revision: Union[str, None] = '4baa8f03b8ec'
...
def upgrade():
    ...
    csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl12_13.csv")
