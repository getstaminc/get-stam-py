...
Revision ID: db145775dbe7
Revises: 4712855d1635
Create Date: 2025-07-08 21:00:40.875332
...
revision: str = 'db145775dbe7'
down_revision: Union[str, None] = '4712855d1635'
...
def upgrade():
    ...
    csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "soccer_csvs", "condensed columns - epl13_14.csv")
